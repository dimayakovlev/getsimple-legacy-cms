...
<div class="bodycontent clearfix">
	...
	<div id="maincontent">
		<div class="main">
			...
			<table class="highlight healthcheck">
				<tr><td style="width: 445px;"><?php echo GSNAME; ?> <?php i18n('VERSION'); ?></td><td><span class="<?php echo isAlpha() ? 'ERRmsg' : (isBeta() ? 'WARNmsg' : 'OKmsg'); ?>"><b><?php echo GSVERSION; ?></b></span></td></tr>
                <?php 
	...
	?>
			...
			<table class="highlight healthcheck">
				<?php $me = check_perms(GSDATAOTHERPATH.'plugins.xml'); ?><tr><td>/data/other/plugins.xml</td><td><?php if( $me >= '0644' ) { echo '<span class="OKmsg" >'. $me .' '.i18n_r('WRITABLE').' - '.i18n_r('OK').'</span>'; } else { echo '<span class="ERRmsg" >'. $me .' '.i18n_r('NOT_WRITABLE').' - '.i18n_r('ERROR').'!</span>'; } ?></td></tr>
