 ...
 * Reset Password
 *
 * Resets the password for GetSimple Legacy control panel access
 *
...
<div class="wrapper clearfix">
	...
	<div id="maincontent">
		...
		<form class="login" action="<?php myself(); ?>" method="post">
			...
			<p><label for="username"><?php i18n('LABEL_USERNAME'); ?>:</label><input class="text" name="username" type="text" value="" /></p>
